...
## [5.0.0-rc3](https://github.com/max-pfeiffer/testcontainers-python/compare/testcontainers-v4.15.0-rc3...testcontainers-v5.0.0-rc3) (2026-06-05)
...
* Add ExecWaitStrategy and migrate Postgres from deprecated decorator ([#935](https://github.com/max-pfeiffer/testcontainers-python/issues/935)) ([2d9eee3](https://github.com/max-pfeiffer/testcontainers-python/commit/2d9eee30442ec8adbf4a42fcd308cd6377b41c06))
* Add SocatContainer ([#795](https://github.com/max-pfeiffer/testcontainers-python/issues/795)) ([2f9139c](https://github.com/max-pfeiffer/testcontainers-python/commit/2f9139ca3ea9fba36325373b63635a5f539a3003))
...
* **azurite:** Enhance connection string generation for network and local access ([#859](https://github.com/max-pfeiffer/testcontainers-python/issues/859)) ([b21e5e3](https://github.com/max-pfeiffer/testcontainers-python/commit/b21e5e38075ddbd71fb4f97e843abc104dec6beb))
...
* **compose:** add structured container inspect information ([#897](https://github.com/max-pfeiffer/testcontainers-python/issues/897)) ([58459a1](https://github.com/max-pfeiffer/testcontainers-python/commit/58459a13a1523c5dec8b21b0e16ae1afdce48156))
...
* **core:** add enhanced wait strategies ([#855](https://github.com/max-pfeiffer/testcontainers-python/issues/855)) ([60d21f8](https://github.com/max-pfeiffer/testcontainers-python/commit/60d21f875f49f52e170b0714e8790080a6cb4c71))
* **core:** add Podman compatibility ([#1028](https://github.com/max-pfeiffer/testcontainers-python/issues/1028)) ([37093ab](https://github.com/max-pfeiffer/testcontainers-python/commit/37093ab8e1a86d1aecbad915f1af20934861ac35))
...
* **core:** auto-detect DOCKER_HOST from current docker context ([#1026](https://github.com/max-pfeiffer/testcontainers-python/issues/1026)) ([d4b8ff6](https://github.com/max-pfeiffer/testcontainers-python/commit/d4b8ff66197e7eb57708c9579fa1fb41d6988f5e)), closes [#1025](https://github.com/max-pfeiffer/testcontainers-python/issues/1025)
* **core:** DockerCompose: support list of env_files ([#847](https://github.com/max-pfeiffer/testcontainers-python/issues/847)) ([fe206eb](https://github.com/max-pfeiffer/testcontainers-python/commit/fe206eb48ee9e18623761926900bfc33a8a869a7))
...
* **core:** Image build (Dockerfile support) ([#585](https://github.com/max-pfeiffer/testcontainers-python/issues/585)) ([54c88cf](https://github.com/max-pfeiffer/testcontainers-python/commit/54c88cf00ad7bb08eb7894c52bed7a9010fd7786))
...
* **core:** Protocol support for container port bind and expose ([#690](https://github.com/max-pfeiffer/testcontainers-python/issues/690)) ([a0d4317](https://github.com/max-pfeiffer/testcontainers-python/commit/a0d4317643005dde4f344eccbfc56c062e83bf05))
* **core:** support SSH-based DOCKER_HOST ([#993](https://github.com/max-pfeiffer/testcontainers-python/issues/993)) ([d48115d](https://github.com/max-pfeiffer/testcontainers-python/commit/d48115def127644964d4d2b09a38e3f4492cc43c))
* **core:** support TESTCONTAINERS_HUB_IMAGE_NAME_PREFIX ([#961](https://github.com/max-pfeiffer/testcontainers-python/issues/961)) ([be9a0a6](https://github.com/max-pfeiffer/testcontainers-python/commit/be9a0a612d934c77bdde20defd4d9f7d5228fb0c))
...
* DockerContainer initializer to accept its private members as kwargs ([#809](https://github.com/max-pfeiffer/testcontainers-python/issues/809)) ([e7feb53](https://github.com/max-pfeiffer/testcontainers-python/commit/e7feb53fe532b6d32d5d0c5a5d517249f8e7de50))
* **generic:** Reintroducing the generic SQL module ([#892](https://github.com/max-pfeiffer/testcontainers-python/issues/892)) ([2ca2321](https://github.com/max-pfeiffer/testcontainers-python/commit/2ca2321ada12e09d491280c8ec855bf8511de7c2))
* **kafka:** allow configurable listener name and security protocol ([#966](https://github.com/max-pfeiffer/testcontainers-python/issues/966)) ([44dd40b](https://github.com/max-pfeiffer/testcontainers-python/commit/44dd40b48c3a5020b487bae5d460124d9e594ac3))
* **keycloak:** support for relative path and management relative path ([#982](https://github.com/max-pfeiffer/testcontainers-python/issues/982)) ([898faf6](https://github.com/max-pfeiffer/testcontainers-python/commit/898faf6a5955698958be6e8cfd32b87323d62a44))
...
* **main:** New Testcontainers Python Docs Site ([#822](https://github.com/max-pfeiffer/testcontainers-python/issues/822)) ([a6bdf0e](https://github.com/max-pfeiffer/testcontainers-python/commit/a6bdf0ef84643074fbc7edf3a75936ce3f1d0880))
* make config monkeypatchable, fix config related startup issues ([#833](https://github.com/max-pfeiffer/testcontainers-python/issues/833)) ([ff6a32d](https://github.com/max-pfeiffer/testcontainers-python/commit/ff6a32db803046db8d89ba5a7157bf573d9f25c2))
* **modules:** add OpenFGA module ([#762](https://github.com/max-pfeiffer/testcontainers-python/issues/762)) ([0b7b482](https://github.com/max-pfeiffer/testcontainers-python/commit/0b7b482f9ec807e87fd43d1372226fa43eb4ed7c))
* **mongodb:** Add Atlas Local for MongoDb ([#873](https://github.com/max-pfeiffer/testcontainers-python/issues/873)) ([73aeb43](https://github.com/max-pfeiffer/testcontainers-python/commit/73aeb43c18d56993d7c2626fb598a01842a91c35))
* **mqtt:** MosquittoContainer: Add version 2.1.2 ([#978](https://github.com/max-pfeiffer/testcontainers-python/issues/978)) ([af382f7](https://github.com/max-pfeiffer/testcontainers-python/commit/af382f74e82bdcb14eac3f4e04a83432ae9beeba))
...
* set multiple variables via keyword args ([#804](https://github.com/max-pfeiffer/testcontainers-python/issues/804)) ([1532df5](https://github.com/max-pfeiffer/testcontainers-python/commit/1532df5e9094d15b9f3e9233e7f5843d8bc24386))
...
* support with_copy_to ([#976](https://github.com/max-pfeiffer/testcontainers-python/issues/976)) ([59ec1ce](https://github.com/max-pfeiffer/testcontainers-python/commit/59ec1ce6dc7d54fa7f4b3c69f5bf674dfd19bfc0))
* **valkey:** add Valkey module ([#947](https://github.com/max-pfeiffer/testcontainers-python/issues/947)) ([fc09dc1](https://github.com/max-pfeiffer/testcontainers-python/commit/fc09dc17bccd45d57d92f12c0de26b99ab1ccecf))
...
* add ruff to deps ([#919](https://github.com/max-pfeiffer/testcontainers-python/issues/919)) ([5853d32](https://github.com/max-pfeiffer/testcontainers-python/commit/5853d326bb4e9631b7c58355c53ff7fc3ecab92d))
...
* added types to exec & tc_properties_get_tc_host ([#561](https://github.com/max-pfeiffer/testcontainers-python/issues/561)) ([9eabb79](https://github.com/max-pfeiffer/testcontainers-python/commit/9eabb79f213cfb6d8e60173ff4c40f580ae0972a))
...
* Allow passing in a custom wait strategy string in MySQL, Cassandra, Kafka and Trino ([#953](https://github.com/max-pfeiffer/testcontainers-python/issues/953)) ([be4d09e](https://github.com/max-pfeiffer/testcontainers-python/commit/be4d09ecb3f65089d06fbd1ab9d4f12e9009ed8b))
...
* assert-in-get_container_host_ip-before-start ([#862](https://github.com/max-pfeiffer/testcontainers-python/issues/862)) ([fc4155e](https://github.com/max-pfeiffer/testcontainers-python/commit/fc4155eb70509ba236fff771c2f8973667acb098))
* **azurite:** make visible to type checkers ([#927](https://github.com/max-pfeiffer/testcontainers-python/issues/927)) ([baa5668](https://github.com/max-pfeiffer/testcontainers-python/commit/baa566814b22fa922094a625ff92037cbe8bd93f))
* **azurite:** use `HttpWaitStrategy` instead of deprecated `wait_container_is_ready` ([#1003](https://github.com/max-pfeiffer/testcontainers-python/issues/1003)) ([9fe6b07](https://github.com/max-pfeiffer/testcontainers-python/commit/9fe6b074852e5d6f1df2942bda52ee0557e5cb32)), closes [#874](https://github.com/max-pfeiffer/testcontainers-python/issues/874)
...
* **cassandra,mysqk,kafka:** Use wait strategy instead of deprecated wait_for_logs ([#945](https://github.com/max-pfeiffer/testcontainers-python/issues/945)) ([b7791b9](https://github.com/max-pfeiffer/testcontainers-python/commit/b7791b945134940c3185baa3eab009f06d0338a9))
...
* Change env var disabling OpenSearch security plugin ([#773](https://github.com/max-pfeiffer/testcontainers-python/issues/773)) ([2620d7f](https://github.com/max-pfeiffer/testcontainers-python/commit/2620d7fb1157caa18c3bef4bf2f9b3b79cd2f075))
...
* **clickhouse:** add `HttpWaitStrategy` instead of deprecated `wait_container_is_ready` ([#962](https://github.com/max-pfeiffer/testcontainers-python/issues/962)) ([8034541](https://github.com/max-pfeiffer/testcontainers-python/commit/803454147c03418b7b06601d251eb491a2cd79cf))
...
* **compose:** expose useful compose options ([#951](https://github.com/max-pfeiffer/testcontainers-python/issues/951)) ([183e1aa](https://github.com/max-pfeiffer/testcontainers-python/commit/183e1aa1bcd684d36d3f5b52b28965c851f5436f))
* **compose:** return type in get_service_port docstring ([#939](https://github.com/max-pfeiffer/testcontainers-python/issues/939)) ([fed65fe](https://github.com/max-pfeiffer/testcontainers-python/commit/fed65fe14507020007c115c535364c90d4bbdde9))
* **compose:** use provided docker command instead of default ([#785](https://github.com/max-pfeiffer/testcontainers-python/issues/785)) ([0ae704a](https://github.com/max-pfeiffer/testcontainers-python/commit/0ae704a24de440b715d5f3c11eaa4f18ccd437b5))
...
* **core:** add container logs to TimeoutError when wait strategy times out ([#1007](https://github.com/max-pfeiffer/testcontainers-python/issues/1007)) ([1fadb40](https://github.com/max-pfeiffer/testcontainers-python/commit/1fadb40c456c3ccd4f13b1b82cd19c3ab22c2687))
...
* **core:** Add kwargs to image build ([#708](https://github.com/max-pfeiffer/testcontainers-python/issues/708)) ([cc02f94](https://github.com/max-pfeiffer/testcontainers-python/commit/cc02f9444b41efa62836b21210b07aee1da94d0b))
...
* **core:** Added 'compose' in compose_command_property ([#879](https://github.com/max-pfeiffer/testcontainers-python/issues/879)) ([769b7b6](https://github.com/max-pfeiffer/testcontainers-python/commit/769b7b688fe254cb8e38e05f453c4e3fe7999ad5))
...
* **core:** bring back dind tests ([7337266](https://github.com/max-pfeiffer/testcontainers-python/commit/7337266c73f05f003378ff483a5e3b565a1e86c5))
* **core:** change with_command type to include list of strings ([#789](https://github.com/max-pfeiffer/testcontainers-python/issues/789)) ([f7c29cb](https://github.com/max-pfeiffer/testcontainers-python/commit/f7c29cb913e4d42d535783c3aa0f3566d4e543bf))
* **core:** close Reaper socket at interpreter exit to prevent ResourceWarning ([#1017](https://github.com/max-pfeiffer/testcontainers-python/issues/1017)) ([d3a1517](https://github.com/max-pfeiffer/testcontainers-python/commit/d3a1517f2c5c2e2a48a4c051b2203b80d9141759))
* **core:** create_label test ([#771](https://github.com/max-pfeiffer/testcontainers-python/issues/771)) ([7517297](https://github.com/max-pfeiffer/testcontainers-python/commit/751729722a013b46f67c09b4318b1b3d92b98008))
* **core:** Determine docker socket for rootless docker ([#779](https://github.com/max-pfeiffer/testcontainers-python/issues/779)) ([6817582](https://github.com/max-pfeiffer/testcontainers-python/commit/6817582bf67ed36448b69019ab897c50ae80e7e1))
...
* **core:** env vars not being respected due to constructor call ([#524](https://github.com/max-pfeiffer/testcontainers-python/issues/524)) ([4872ea5](https://github.com/max-pfeiffer/testcontainers-python/commit/4872ea5759347e10150c0d80e4e7bbce3d59c410)), closes [#521](https://github.com/max-pfeiffer/testcontainers-python/issues/521)
* **core:** Fix issues with doctests ([#893](https://github.com/max-pfeiffer/testcontainers-python/issues/893)) ([2e4d80a](https://github.com/max-pfeiffer/testcontainers-python/commit/2e4d80ade5a2048c8bc79d7a2438004b8e0954e4))
* **core:** improper reading of .testcontainers.properties ([#863](https://github.com/max-pfeiffer/testcontainers-python/issues/863)) ([350f246](https://github.com/max-pfeiffer/testcontainers-python/commit/350f246a3b6367d727046b8967a63d1c055cf324))
...
* **core:** make sure context manager exits ([#876](https://github.com/max-pfeiffer/testcontainers-python/issues/876)) ([10089f6](https://github.com/max-pfeiffer/testcontainers-python/commit/10089f6e2fe07e53cc47a69521e67a1bf3310065))
* **core:** Make TC_POOLING_INTERVAL/sleep_time a float ([#839](https://github.com/max-pfeiffer/testcontainers-python/issues/839)) ([a072f3f](https://github.com/max-pfeiffer/testcontainers-python/commit/a072f3fad46b3b3e7c5bea6255f27b79826aaf5f))
* **core:** multiple container start invocations with custom labels ([#769](https://github.com/max-pfeiffer/testcontainers-python/issues/769)) ([3e783a8](https://github.com/max-pfeiffer/testcontainers-python/commit/3e783a80aa11b9c87201404a895d922624f0d451))
* **core:** mypy ([#810](https://github.com/max-pfeiffer/testcontainers-python/issues/810)) ([b816762](https://github.com/max-pfeiffer/testcontainers-python/commit/b816762b9a548033b065c3f46267c289a560f6ed))
...
* **core:** recreate poetry lockfile with latest versions of libraries ([#946](https://github.com/max-pfeiffer/testcontainers-python/issues/946)) ([9a97385](https://github.com/max-pfeiffer/testcontainers-python/commit/9a9738575ec3f831c78512b10b990e416eacad03))
* **core:** Refactor copy file ([#996](https://github.com/max-pfeiffer/testcontainers-python/issues/996)) ([0e0bb24](https://github.com/max-pfeiffer/testcontainers-python/commit/0e0bb24a2bddfd8a03bebdfc3b9ff8cf8c78092b))
...
* **core:** Typing in docker_client ([#702](https://github.com/max-pfeiffer/testcontainers-python/issues/702)) ([e8bf224](https://github.com/max-pfeiffer/testcontainers-python/commit/e8bf2244c7210e31b34e5fecf2602fdd1b8c0834))
* **core:** Typing in generic + network ([#700](https://github.com/max-pfeiffer/testcontainers-python/issues/700)) ([2061912](https://github.com/max-pfeiffer/testcontainers-python/commit/2061912e67705be801136f349f372f542a1f262f))
* **core:** Typing in version ([#701](https://github.com/max-pfeiffer/testcontainers-python/issues/701)) ([9dc2a02](https://github.com/max-pfeiffer/testcontainers-python/commit/9dc2a02ca9b9ffbaacfd7de79ec9f78175758ec0))
...
* **core:** Use WaitStrategy internally for wait_for function ([#942](https://github.com/max-pfeiffer/testcontainers-python/issues/942)) ([e323317](https://github.com/max-pfeiffer/testcontainers-python/commit/e323317838552a9f8046b2a8e24a03c07ff8890e))
* **core:** wait for ryuk more reliably, improve tests: long_running, filter logs ([#984](https://github.com/max-pfeiffer/testcontainers-python/issues/984)) ([b12ae13](https://github.com/max-pfeiffer/testcontainers-python/commit/b12ae13e589a4ffe326c162a38df56eb30521d69))
* **core:** wait in test core registry ([#812](https://github.com/max-pfeiffer/testcontainers-python/issues/812)) ([b574c0e](https://github.com/max-pfeiffer/testcontainers-python/commit/b574c0e0a11d57c8c56aef448292f8c2fc233078))
* **core:** waiting improvements + remove decorators in core ([#894](https://github.com/max-pfeiffer/testcontainers-python/issues/894)) ([f93f379](https://github.com/max-pfeiffer/testcontainers-python/commit/f93f379380a9de769fe6a1e1168622865cdf613d))
...
* **cosmosdb:** replace distutils.strtobool removed in Python 3.12 ([#1018](https://github.com/max-pfeiffer/testcontainers-python/issues/1018)) ([3e487f4](https://github.com/max-pfeiffer/testcontainers-python/commit/3e487f4bab679204820826cfcbc282cb8fc60008))
...
* do not require consumer of library to state nonsupport for py4 ([#912](https://github.com/max-pfeiffer/testcontainers-python/issues/912)) ([f608df9](https://github.com/max-pfeiffer/testcontainers-python/commit/f608df908f87674484b106831d8e8019fdc1927c))
* **docs:** Update dependencies for docs ([#900](https://github.com/max-pfeiffer/testcontainers-python/issues/900)) ([3f66784](https://github.com/max-pfeiffer/testcontainers-python/commit/3f667847a0d9a893e4f15481d81d131817382d5c))
...
* **elasticsearch:** Use wait strategy instead of deprecated decorator ([#915](https://github.com/max-pfeiffer/testcontainers-python/issues/915)) ([c785ecd](https://github.com/max-pfeiffer/testcontainers-python/commit/c785ecdca20b51e077ab23ed61ae123c643a0627))
* Enable mypy in the CI ([#842](https://github.com/max-pfeiffer/testcontainers-python/issues/842)) ([ef65bd1](https://github.com/max-pfeiffer/testcontainers-python/commit/ef65bd113b564bce614aaf6df13bbf5339b9bc58))
...
* fix pr [#961](https://github.com/max-pfeiffer/testcontainers-python/issues/961) ([#1011](https://github.com/max-pfeiffer/testcontainers-python/issues/1011)) ([8eff908](https://github.com/max-pfeiffer/testcontainers-python/commit/8eff90851eecaf5720021d63e852a927c47f978c))
...
* **generic:** Migrate ServerContainer from deprecated decorator to HttpWaitStrategy ([#971](https://github.com/max-pfeiffer/testcontainers-python/issues/971)) ([460b0d8](https://github.com/max-pfeiffer/testcontainers-python/commit/460b0d8a09635068815ea8c5c5a4e4cc1e3dfea7))
...
* **google:** add support for Datastore emulator ([#508](https://github.com/max-pfeiffer/testcontainers-python/issues/508)) ([3d891a5](https://github.com/max-pfeiffer/testcontainers-python/commit/3d891a5ec62944d01d1bf3d6f70e6aec83f6e516))
...
* issue [#889](https://github.com/max-pfeiffer/testcontainers-python/issues/889) by changing the annotated return type of `waiting_for` to `Self`. ([#890](https://github.com/max-pfeiffer/testcontainers-python/issues/890)) ([fe941b1](https://github.com/max-pfeiffer/testcontainers-python/commit/fe941b17bb97aad15dc4844996f166c9308f4476))
* just use the getLogger API and do not override logger settings ([#836](https://github.com/max-pfeiffer/testcontainers-python/issues/836)) ([f467c84](https://github.com/max-pfeiffer/testcontainers-python/commit/f467c842b851613b9a087bd5f9a08d8c39577cb8))
...
* **kafka:** Use wait strategy instead of deprecated wait_for_logs ([#903](https://github.com/max-pfeiffer/testcontainers-python/issues/903)) ([87332c1](https://github.com/max-pfeiffer/testcontainers-python/commit/87332c1332a30b673aac919b48e296e21f2c1baf))
...
* **keycloak:** Fixed Keycloak testcontainer for latest version v26.1.0 ([#766](https://github.com/max-pfeiffer/testcontainers-python/issues/766)) ([b1642e9](https://github.com/max-pfeiffer/testcontainers-python/commit/b1642e98c4d349564c4365782d1b58c9810b719a))
...
* **minio:** minio client requires kwargs now ([#933](https://github.com/max-pfeiffer/testcontainers-python/issues/933)) ([37f5902](https://github.com/max-pfeiffer/testcontainers-python/commit/37f590278f23851c4f8244d4add7aa6f8ed3bc62))
* **minio:** Use wait strategy instead of deprecated decorator ([#899](https://github.com/max-pfeiffer/testcontainers-python/issues/899)) ([febccb7](https://github.com/max-pfeiffer/testcontainers-python/commit/febccb78b5b4b00d2a3bda27f09e6b4d4c9dfde3))
...
* **modules:** fix cosmosdb failure ([#827](https://github.com/max-pfeiffer/testcontainers-python/issues/827)) ([dafcbed](https://github.com/max-pfeiffer/testcontainers-python/commit/dafcbed7608e857bebcdd0b4638bec27abadc693))
...
* **modules:** update chroma version ([#826](https://github.com/max-pfeiffer/testcontainers-python/issues/826)) ([b7d41dd](https://github.com/max-pfeiffer/testcontainers-python/commit/b7d41ddc5742dd380b6e01c712a02b044a64cbb3))
* **mongodb:** Use wait strategy instead of deprecated wait_for_logs ([#943](https://github.com/max-pfeiffer/testcontainers-python/issues/943)) ([c8118e7](https://github.com/max-pfeiffer/testcontainers-python/commit/c8118e7c9832743486115221fd8253bdc8c2a5ec))
...
* **mongo:** mongo start waiting forever for old mongo versions ([#783](https://github.com/max-pfeiffer/testcontainers-python/issues/783)) ([1388612](https://github.com/max-pfeiffer/testcontainers-python/commit/13886120e9cb72666a40ea3691ea13e584805918))
* move TESTCONTAINERS_HOST_OVERRIDE to config.py ([#603](https://github.com/max-pfeiffer/testcontainers-python/issues/603)) ([2a5a190](https://github.com/max-pfeiffer/testcontainers-python/commit/2a5a1904391020a9da4be17b32f23b36d9385c29)), closes [#602](https://github.com/max-pfeiffer/testcontainers-python/issues/602)
...
* **mssql:** use `ExecWaitStrategy` instead of deprecated `wait_container_is_ready` ([#1016](https://github.com/max-pfeiffer/testcontainers-python/issues/1016)) ([4c53b89](https://github.com/max-pfeiffer/testcontainers-python/commit/4c53b89a1faad9a592d2bb49123ef3e6bf33fdb9)), closes [#874](https://github.com/max-pfeiffer/testcontainers-python/issues/874)
...
* **nats:** add support for jetstream ([#938](https://github.com/max-pfeiffer/testcontainers-python/issues/938)) ([49c9af8](https://github.com/max-pfeiffer/testcontainers-python/commit/49c9af8cf542feb5df9ec389d554edd7645a4dc4))
...
* **neo4j:** Swap out use of depricated wait utils for wait_strategies ([#1012](https://github.com/max-pfeiffer/testcontainers-python/issues/1012)) ([6deaf3b](https://github.com/max-pfeiffer/testcontainers-python/commit/6deaf3b27e5f8d54ff9ae404dbd092e8014df079))
...
* **ollama:** make device request a list ([#799](https://github.com/max-pfeiffer/testcontainers-python/issues/799)) ([9497a45](https://github.com/max-pfeiffer/testcontainers-python/commit/9497a45c39d13761aa3dd30dd5605676cbbe4b46))
...
* **postgres:** add py.typed marker to postgres module ([#849](https://github.com/max-pfeiffer/testcontainers-python/issues/849)) ([c8a5bbd](https://github.com/max-pfeiffer/testcontainers-python/commit/c8a5bbdbab137e6dc5af9a7224e65972665ec84d))
...
* **qdrant:** migrate Qdrant from deprecated decorator. ([#963](https://github.com/max-pfeiffer/testcontainers-python/issues/963)) ([407f798](https://github.com/max-pfeiffer/testcontainers-python/commit/407f79825be97865010dc0119cdfe3498a609a08))
...
* **rabbitmq:** add `vhost` as parameter to RabbitMqContainer ([#656](https://github.com/max-pfeiffer/testcontainers-python/issues/656)) ([fa2081a](https://github.com/max-pfeiffer/testcontainers-python/commit/fa2081a7b325cdd316de28c99b029150022db203))
* **rabbitmq:** correct pika pypi reference ([#817](https://github.com/max-pfeiffer/testcontainers-python/issues/817)) ([e90d308](https://github.com/max-pfeiffer/testcontainers-python/commit/e90d30826fb7d7cf3cc7db39a86465d448aaa6e0))
...
* **redis:** Use wait strategy instead of deprecated decorator ([#914](https://github.com/max-pfeiffer/testcontainers-python/issues/914)) ([e25713a](https://github.com/max-pfeiffer/testcontainers-python/commit/e25713a300eda6a14973d2465590d2318dcc375d))
* **redpanda:** copy the startup script to a path that can be written … ([#867](https://github.com/max-pfeiffer/testcontainers-python/issues/867)) ([e6b976d](https://github.com/max-pfeiffer/testcontainers-python/commit/e6b976de43fc6fe90d7131fd25983f9c6b08429b))
* **registry:** module typed ([#811](https://github.com/max-pfeiffer/testcontainers-python/issues/811)) ([6b11268](https://github.com/max-pfeiffer/testcontainers-python/commit/6b1126884c82529a93bd55030374d322dd0870bc))
...
* **scylla:** scylla get cluster method ([#778](https://github.com/max-pfeiffer/testcontainers-python/issues/778)) ([46913c1](https://github.com/max-pfeiffer/testcontainers-python/commit/46913c18a8b6f37bf8dc193828148926b6fc56a8))
* **security:** Update track-modules job  ([#787](https://github.com/max-pfeiffer/testcontainers-python/issues/787)) ([f979525](https://github.com/max-pfeiffer/testcontainers-python/commit/f97952505eba089f9cbbc979f8091dafbf520669))
...
* **sftp:** Avoid using wait_for_logs in module. ([#995](https://github.com/max-pfeiffer/testcontainers-python/issues/995)) ([83157eb](https://github.com/max-pfeiffer/testcontainers-python/commit/83157eb4acd931949cfec3d2a84db0a61685e739))
* Support Elasticsearch 9.x ([#881](https://github.com/max-pfeiffer/testcontainers-python/issues/881)) ([f690e88](https://github.com/max-pfeiffer/testcontainers-python/commit/f690e88e866ef3ff30ba2cd18958fc1fc07f89c8)), closes [#860](https://github.com/max-pfeiffer/testcontainers-python/issues/860)
...
* **trino:** Remove deprecated class and decorator from Trino container ([#895](https://github.com/max-pfeiffer/testcontainers-python/issues/895)) ([bb646e9](https://github.com/max-pfeiffer/testcontainers-python/commit/bb646e903236a1df72bc38dbb47d1dba95527198))
...
* use connection mode override function in config ([#775](https://github.com/max-pfeiffer/testcontainers-python/issues/775)) ([ab2a1ab](https://github.com/max-pfeiffer/testcontainers-python/commit/ab2a1abd957ffb35719f673a7674df83287f1545)), closes [#774](https://github.com/max-pfeiffer/testcontainers-python/issues/774)
...
* Fixed typo in CONTRIBUTING.md ([#767](https://github.com/max-pfeiffer/testcontainers-python/issues/767)) ([f0bb0f5](https://github.com/max-pfeiffer/testcontainers-python/commit/f0bb0f54bea83885698bd137e24c397498709362))
...
* missing compose html from old docs ([#776](https://github.com/max-pfeiffer/testcontainers-python/issues/776)) ([d749fc6](https://github.com/max-pfeiffer/testcontainers-python/commit/d749fc69b32715742d834c003ee6893e2077753a))
